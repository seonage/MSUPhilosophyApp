...
public class religion_minor extends ActionBarActivity {

    HashMap<String, List<String>> Minor_Religion_Category;
    List<String> Minor_Religion_List;
    ExpandableListView Exp_list;
    MinorReligionAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_religion_minor);
        Exp_list = (ExpandableListView)findViewById(R.id.expandable_religion_minor_ListView);
        Minor_Religion_Category = Minor_Religion_Provider.getInfo();
        Minor_Religion_List = new ArrayList<>(Minor_Religion_Category.keySet());
        adapter = new MinorReligionAdapter(this,Minor_Religion_Category,Minor_Religion_List);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_religion_minor, menu);
        return true;
    }
