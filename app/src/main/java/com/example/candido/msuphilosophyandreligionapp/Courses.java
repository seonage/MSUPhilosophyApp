...
public class Courses extends ActionBarActivity {
    ...
    public class scrapePage extends AsyncTask<Void, Void, Void>
    {
        ...
        TextView pageText = (TextView) findViewById(R.id.coursesText);

        protected Void doInBackground(Void... params)
        {
            try
            {
                Document doc = Jsoup.connect("http://www.montclair.edu/chss/philosophy-religion/philosophy/fall2015courses/").get();
                classesArticle = doc.select("article p");
        ...
        protected void onPostExecute (Void result)
        {
            try
            {
                ...
                pageText.setText(Html.fromHtml(classesString));
            }

            catch (java.lang.NullPointerException e)
            {
                e.printStackTrace();
                pageText.setText("No internet connection. You must be connected to the internet to display this");
            }
        }
    }
}
